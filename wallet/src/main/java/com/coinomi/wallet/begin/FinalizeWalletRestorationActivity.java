...
import com.coinomi.wallet.ui.IntroActivity;
 ...
 */
public class FinalizeWalletRestorationActivity extends Activity {
    private static final Logger log = LoggerFactory.getLogger(FinalizeWalletRestorationActivity.class);
...
//        FinalizeWalletRestorationActivity fragment = new FinalizeWalletRestorationActivity();
//        fragment.setRetainInstance(true);
//        fragment.setArguments(args);
//        return fragment;
//    }
//
//    public FinalizeWalletRestorationActivity() {
...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_finalize_wallet_restoration);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        mContext = FinalizeWalletRestorationActivity.this;

        status = (TextView) findViewById(R.id.restoration_status);
...
//    }
    ...
    private static class MyHandler extends WeakHandler<FinalizeWalletRestorationActivity> {
        public MyHandler(FinalizeWalletRestorationActivity ref) {
            super(ref);
        }

        @Override
        protected void weakHandleMessage(FinalizeWalletRestorationActivity ref, Message msg) {
            switch (msg.what) {
